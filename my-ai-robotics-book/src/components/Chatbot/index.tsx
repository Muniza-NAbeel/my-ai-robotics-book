...
function Chatbot() {
  ...
  // ✅ Default welcome message added safely
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: 'Hello! I am your Physical AI assistant. Ask me anything about this book!',
      sender: 'bot',
      selectedText: null,
    },
  ]);
  ...
  const sendMessage = useCallback(
    async (question: string, selectedText: string | null = null) => {
      ...
      {isOpen && (
        <div className={styles.chatWindow}>
          ...
          <div className={styles.chatMessages}>
            {messages.map((msg) => (
              ...
              >
                {msg.text}
                {msg.selectedText && (
                  <p className={styles.selectedTextContext}>
                    Context: "{msg.selectedText}"
                  </p>
                )}
              </div>
            ))}
          ...
          <div className={styles.chatInputContainer}>
            ...
            <button
              onClick={handleAskWithSelection}
